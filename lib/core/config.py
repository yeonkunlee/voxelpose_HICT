...
config.DATASET.FOCAL_LENGTH_AUGMENTATION = False # yk
config.DATASET.GRID_ZROTATION_AUGMENTATION = False # yk
config.DATASET.SPACE_XYTRANSLATION_AUGMENTATION = False # yk
